...
export default function Profile() {
  ...
  const renderTime = (totalSeconds, unitColorClass = "text-gray-200") => {
      ...
      <div className="relative pt-32 px-4 md:px-8 max-w-7xl mx-auto space-y-8 animate-fade-in">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end border-b border-outline-variant/20 pb-8">
          <div className="lg:col-span-8 flex flex-col md:flex-row items-center md:items-end space-y-6 md:space-y-0 md:space-x-8">
            ...
            <div className="flex-1 text-center md:text-left space-y-2 min-w-0">
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
                 <span title={player.name} className="font-headline text-3xl md:text-4xl lg:text-5xl font-black tracking-tighter text-gray-200 uppercase leading-none break-all max-w-full">{player.name}</span>
                 
                 {showFirstName && (
                   <div className="group relative flex items-center justify-center cursor-help mt-1 md:mt-2">
                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-6 h-6 text-gray-200 hover:text-primary-dim transition-colors duration-200" fill="currentColor">
                     ...
                     <div className="pointer-events-none absolute bottom-full left-1/2 -translate-x-1/2 mb-2.5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 bg-black/60 backdrop-blur-md border border-white/10 px-5 py-2.5 rounded-sm shadow-[0_5px_15px_rgba(0,0,0,0.5)] z-[999] w-max min-w-[120px] text-center">
                        ...
                        <p className="font-headline text-sm text-gray-200 drop-shadow-md">{player.firstname}</p>
              ...
              <div className="flex flex-col gap-2 mt-4">
                ...
                {hasMixStats && (
                  <span className="font-headline text-gray-400 tracking-[0.2em] text-xs font-bold uppercase mb-2">Mix elo: <span className="text-yellow-500">{player.mixelo || player.mixElo || 0}</span> <span className="text-yellow-500">({mixRank})</span></span>
                )}
          ...
          <div className="lg:col-span-4 flex justify-center lg:justify-end items-center lg:items-end">
            <a href={steamLink} target="_blank" rel="noopener noreferrer" className="group relative px-8 py-4 bg-primary-dim text-gray-200 font-headline font-bold uppercase tracking-widest text-sm overflow-hidden transition-all duration-300 hover:shadow-[0_0_30px_rgba(233,0,54,0.4)] w-full lg:w-auto text-center mt-4 lg:mt-0">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-[1fr_1.3fr] gap-6 mt-8 items-stretch">
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
               <div className="flex flex-wrap items-center gap-x-8 gap-y-2 py-1">
                 ...
                 <div className="flex flex-col border-l border-white/10 pl-5">
                    ...
                    <span className="font-headline text-[11px] text-gray-200 font-bold tracking-wider">{cheaterInfo.date || 'N/A'}</span>
                 </div>
               </div>
        ...
        <div className="col-span-full relative bg-surface-container-low/80 backdrop-blur-md border border-outline-variant/20 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] mb-2 overflow-hidden">
          ...
          <div className={`p-8 transition-all duration-500 ${!hasMixStats ? 'blur-md opacity-30 select-none' : ''}`}>
            <div className="flex items-center justify-between border-b border-outline-variant/10 pb-4 mb-6">
              <h3 className="font-headline text-xs font-bold uppercase tracking-[0.2em] text-red-500">Mix Competitive Stats</h3>
            </div>
            
            <div className="flex flex-wrap lg:flex-nowrap justify-between w-full items-center gap-6 lg:gap-2 text-center">
              <div className="flex-1 space-y-1">
                <p className="font-headline text-gray-200 text-sm font-bold uppercase tracking-wider flex items-center justify-center gap-2">
                ...
                <p className="font-headline text-[26px] md:text-3xl font-bold text-gray-200 tabular-nums">{formatNumber(player.mixgames || player.mixGames)}</p>
              </div>
              <div className="flex-1 space-y-1">
                <p className="font-headline text-green-500 text-sm font-bold uppercase tracking-wider flex items-center justify-center gap-2">
              ...
              <div className="flex-1 space-y-1 flex flex-col justify-center">
                ...
                <p className="font-headline text-[26px] md:text-3xl font-bold text-gray-200 flex justify-center items-baseline tabular-nums">{renderTime(player.mixtotaltime || player.mixTotalTime, "text-gray-200")}</p>
              </div>
              <div className="flex-1 space-y-1">
                <p className="font-headline text-gray-200 text-sm font-bold uppercase tracking-wider flex items-center justify-center gap-2">
                ...
                <p className="font-headline text-[26px] md:text-3xl font-bold text-gray-200 tabular-nums">{formatNumber(player.mixtotalstabs || player.mixTotalStabs)}</p>
              </div>
              <div className="flex-1 space-y-1">
                <p className="font-headline text-red-500 text-sm font-bold uppercase tracking-wider flex items-center justify-center gap-2">
              ...
              <div className="flex-1 space-y-1">
                <p className="font-headline text-yellow-500 text-sm font-bold uppercase tracking-wider flex items-center justify-center gap-2">
          ...
          <div className="grid grid-cols-3 gap-y-4 gap-x-4">
            ...
            <div className="space-y-0.5 flex flex-col">
              <p className="font-headline text-primary-dim text-xs font-bold uppercase tracking-wider mb-0.5 flex items-center gap-1.5">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-6 h-6 shrink-0" fill="currentColor"><path d="m208.242 24.629-52.058 95.205 95.207 52.059 17.271-31.586-42.424-23.198A143.26 143.26 0 0 1 256 114c78.638 0 142 63.362 142 142s-63.362 142-142 142-142-63.362-142-142c0-16.46 2.785-32.247 7.896-46.928l-32.32-16.16C82.106 212.535 78 233.798 78 256c0 98.093 79.907 178 178 178s178-79.907 178-178S354.093 78 256 78c-13.103 0-25.875 1.44-38.18 4.148l22.008-40.25-31.586-17.27zm104.27 130.379L247 253.275V368h18V258.725l62.488-93.733-14.976-9.984z"/></svg>
                Last 7 Days
              </p>
        ...
        <div className="bg-surface-container-low/80 backdrop-blur-md border border-outline-variant/20 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] flex flex-col h-full min-h-0">
          <div className="flex items-center justify-between border-b border-outline-variant/10 px-6 py-4 shrink-0">
            <h3 className="font-headline text-xs font-bold uppercase tracking-[0.2em] text-red-500">Personal Bests</h3>
            <div className="flex bg-background border border-outline-variant/20 p-0.5">
              <button onClick={() => setJumpMode("PRE")} className={`px-3 py-1 font-headline text-[10px] uppercase tracking-widest transition-colors ${jumpMode === "PRE" ? "bg-primary-dim text-gray-200" : "text-gray-500 hover:text-gray-200"}`}>PRE</button>
              <button onClick={() => setJumpMode("NOPRE")} className={`px-3 py-1 font-headline text-[10px] uppercase tracking-widest transition-colors ${jumpMode === "NOPRE" ? "bg-primary-dim text-gray-200" : "text-gray-500 hover:text-gray-200"}`}>NOPRE</button>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col overflow-y-auto custom-scrollbar px-4 md:px-6 py-4">
             ...
             <div className="flex-1 flex flex-col justify-between pt-3 gap-0">
                {getAllJumps(currentStats).map(j => {
                   ...
                   const distColor = hasRecord ? getJumpColor(j.abbr, j.dist) : "text-gray-700";
                   const syncVal = parseFloat(j.sync || 0);
                   const syncColor = syncVal >= 90 ? "text-green-500" : "text-gray-200";
                   ...
                   return (
                     <div key={j.abbr} title={j.label} className="grid grid-cols-[30px_1.5fr_1fr_1fr_1fr_1fr_1fr] md:grid-cols-[40px_1.5fr_1fr_1fr_1fr_1fr_1fr] text-center items-center bg-gray/30 border border-white/5 py-3 md:py-3.5 px-2 rounded-sm hover:bg-white/[0.03] transition-colors shadow-inner">
                       ...
                       <span className="font-headline text-xs md:text-sm font-bold uppercase tracking-widest text-left text-gray-400">{j.abbr}</span>
                       
                       {hasRecord ? (
                          <>
                            {/* AICI ESTE LOGICA PENTRU DISTANTA COLORATA */}
                            ...
                            <span className="font-headline font-bold text-xs md:text-sm text-gray-200">{parseFloat(j.max || 0).toFixed(0)}</span>
                            <span className="font-headline font-bold text-xs md:text-sm text-gray-200">{parseFloat(j.height || 0).toFixed(2)}</span>
                            <span className="font-headline font-bold text-xs md:text-sm text-gray-200">{parseFloat(j.pre || 0).toFixed(2)}</span>
                            <span className="font-headline font-bold text-xs md:text-sm text-gray-200">{j.str || 0}</span>
